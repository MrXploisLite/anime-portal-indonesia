...
export default function SamehadakuOngoingPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Anime Ongoing - Samehadaku</h1>
        <p className="text-gray-400">Anime yang sedang tayang dari Samehadaku</p>
      </div>
