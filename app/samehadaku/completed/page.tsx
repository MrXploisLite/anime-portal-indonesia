...
export default function SamehadakuCompletedPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const response = await samehadakuApi.getCompleted(page);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Anime Completed - Samehadaku</h1>
        <p className="text-gray-400">Anime yang sudah tamat dari Samehadaku</p>
      </div>
